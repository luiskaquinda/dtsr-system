...
@section('content')
    ...
    <h1 class="text-black fw-semibold px-9 mt-10 mb-6">Lista de Veículos</h1>
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <!--end::Filter-->
                    <!--begin::Export-->
                    <a href="{{ route('pedidos.excel') }}" class="btn btn-light-primary"><i class="fa-solid fa-file-excel fs-2"></i>Exportar</a>
                    <!--end::Export-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
