...
@section('content')
    <form class="container p-4 bg-white rounded" action="{{ route('veiculo.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        ...
        <div class="row p-4">
            <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                    ...
                    <div class="pb-12">
                        <!--begin::Title-->
                        <h1 class="fw-bold text-dark">Cadastrar Veiculo</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                            ...
                            <div class="col mb-0">
                                ...
                                <select name="tipo" class="form-select"  data-control="select2" data-placeholder="Selecione o tipo de pedido">
                                    ...
                                    @foreach ($tipoPedidos as $tipoPedido)
                                        <option value="{{ $tipoPedido->id }}"> {{ $tipoPedido->tipo }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
