...
@section('content')
    <form class="container p-4 bg-white rounded" action="{{ route('veiculo.update', $veiculo->id ) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row p-4">
            <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                    ...
                    <div class="pb-12">
                        <!--begin::Title-->
                        <h1 class="fw-bold text-dark">Editar Veiculo</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                    ...
                    <fieldset class="my-2">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col mb-0">
                                ...
                                <select name="tipo" class="form-select"  data-control="select2" data-placeholder="Selecione o tipo de pedido">
                                    <option></option>
                                    @foreach ($tipoPedidos as $tipoPedido)
                                        <option value="{{ $tipoPedido->id  ?? old('tipo') }}" {{ (isset($tipoPedido->id) && $tipoPedido->id == $veiculo->pedido_matricula->tipo_pedido_id) ? 'selected' : '' }}>{{ $tipoPedido->tipo }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
