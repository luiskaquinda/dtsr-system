...
@section('content')
    ...
    <div class="row g-6 g-xl-9">
        <div class="col-lg-6 col-xxl-4">
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="fs-4 fw-semibold text-gray-400 mb-7">Viaturas Cadastras</div>
                    <!--end::Heading-->
                    <!--begin::Wrapper-->
        ...
        <div class="col-lg-6 col-xxl-4">
            ...
            <div class="card h-100">
                <div class="card-body p-9">
                    <div class="fs-2hx fw-bold">23</div>
                    <div class="fs-4 fw-semibold text-gray-400 mb-7">Total de Registros</div>
                    <div class="fs-6 d-flex justify-content-between mb-4">
                        <div class="fw-semibold">Quantidade de Furtos</div>
                    ...
                    <div class="fs-6 d-flex justify-content-between my-4">
                        <div class="fw-semibold">Quantidade de Acidentes</div>
                        <div class="d-flex fw-bold">
                    ...
                    <div class="fs-6 d-flex justify-content-between mt-4">
                        <div class="fw-semibold">Quantidade de Viaturas</div>
                        <div class="d-flex fw-bold">
                        <i class="ki-duotone ki-arrow-up-right fs-3 me-1 text-success">
                            <span class="path1"></span>
                            <span class="path2"></span>
        ...
        <div class="col-lg-6 col-xxl-4">
            ...
            <div class="card h-100">
                <div class="card-body p-9">
                    <!--begin::Heading-->
                    <div class="fs-2hx fw-bold mb-10">Já Cadastrou o Seu Veiculo?</div>
                    <div class="fs-4 fw-semibold text-gray-400 mb-7">Se Não, Pode Fazê-lo Agora.</div>
                    <!--end::Heading-->
                    <!--begin::Actions-->
                    <div class="d-flex">
                        {{-- <a href="{{ route('proprietario.create') }}" class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">Cadastrar</a>
                        <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Ver Cadastro</a> --}}
                        <a href="{{ route('proprietario.create') }}" class="btn btn-primary btn-sm me-3">Cadastrar</a>
                        <a href="#" class="btn btn-info btn-sm">Ver Cadastro</a>
                    </div>
                    <!--end::Actions-->
                </div>
            </div>
    ...
    <div class="d-flex flex-wrap flex-stack my-5">
        <!--begin::Heading-->
        <h2 class="fs-2 fw-semibold my-2">Ocorrências
        <span class="fs-6 text-gray-400 ms-1">by Sentinel</span></h2>
        <!--end::Heading-->
        <!--begin::Controls-->
