...
<html lang="en">
    ...
    >
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div id="kt_app_header" class="app-header">
					...
					@include('admin.proprietario.partials.header-primary')
					<!--end::Header primary-->
	
					<!--begin::Header secondary-->
					@include('admin.proprietario.partials.header-secondary')
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div class="app-container container-xxl d-flex flex-row flex-column-fluid">
						...
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
							...
							<!--begin::Footer-->
							@include('admin.proprietario.partials.footer')
							<!--end::Footer-->
						</div>
						<!--end:::Main-->
					</div>
		...
		<script src="{{ asset('admin/js/custom/apps/projects/list/list.js') }}"></script>
