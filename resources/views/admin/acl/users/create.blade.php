...
@section('content')
    ...
    <form class="container p-4 bg-white rounded" action="{{ route('role.store') }}" method="POST">
        @csrf
        @method('POST')
        ...
        <div class="row p-4">
            <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                    ...
                    <div class="pb-12">
                        <!--begin::Title-->
                        <h1 class="fw-bold text-dark">Editar Users</h1>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                <span class="required">Nome de usuario</span>
                            ...
                            <!--end::Label-->
                            <input type="text" id="name" name="name" class="form-control" placeholder="e.g. admin" aria-label="First name">
                        </div>
                    </div>
