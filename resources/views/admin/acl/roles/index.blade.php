...
@section('content')
    ...
    <h1 class="text-black fw-semibold px-9 mt-10 mb-6">Lista de Roles</h1>
    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add product-->
                <a href="{{ route('role.create') }}" class="btn btn-primary"><i class="ki-duotone ki-plus fs-2"></i></a>
                <!--end::Add product-->
            </div>
        <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-start min-w-100px">Abilidades Associadas</th>
                    </tr>
                </thead>
                    ...
                    @forelse($roles as $role)
						...
						<tr>
							...
							<td class="text-start pe-0" data-order="15">
								<span class="fw-bold ms-3">{{ $role->name }}</span>
							</td>
							<td class="text-start pe-0" data-order="rating-4">
                                @if ($role->abilities->isEmpty())
                                    <span>Sem abilidade associada</span>
                                @else
							...
							<td class="text-start">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<a href="{{ route('role.edit', ['id' => $role->id ]) }}" class="menu-link px-3">Editar</a>
									</div>
									<!--end::Menu item-->

									<form method="POST" action="{{ route('role.destroy', $role->id) }}" class="menu-item px-3 delete-form">
										@csrf
										@method('delete')
